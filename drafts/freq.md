...
То есть если отказаться от редко используемой буквы `ё`, заменив её на биграмму `йо`, а биграмму `ст` заменить на соответствующую ей букву например `s`, то измеряемый в буквах объем книг и текстов уменьшится на 0,7 %.
