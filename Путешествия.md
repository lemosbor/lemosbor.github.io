...
- <input type="checkbox"> зарядка и шнурок
...
- <input type="checkbox"> латки для надувных кругов
...
# Перед выходом
- <input type="checkbox"> перекрыть воду
- <input type="checkbox"> перекрыть батареи
- <input type="checkbox"> отключить электричество
